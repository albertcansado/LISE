<div class="pageoverflow">
	...
	<div class="pageinput">
		...
		<div class="lise-checkbox-buttons" id="{$actionid}customfield{$fielddef->GetId()}-checkboxes">
		...
		{html_checkboxes name="`$actionid`customfield[`$fielddef->GetId()`]" options=$fielddef->GetOptions() selected=$fielddef->GetValue("array") separator=$fielddef->Separator() assign='liseboxes'}
