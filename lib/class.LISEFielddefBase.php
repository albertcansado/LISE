...
abstract class LISEFielddefBase implements ArrayAccess
{
  ...
  /**
   * True if field is used only on admin section
   * @var bool
   */
  protected $adminField = false;
  ...
  {
    return (bool)$this->isAdminField;
  }

  public function enableAdminField()
  {
  ...
  public function disableAdminField()
  {
